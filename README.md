...
Enfin, une dernière partie (bonus) pourra être dédiée à l’upscaling, dont l’objectif est d’augmenter la résolution des images restaurées afin d’améliorer leur qualité perceptuelle. Pour cela, nous allons implémenter un réseaux de neurones convolutifs (CNN). 
